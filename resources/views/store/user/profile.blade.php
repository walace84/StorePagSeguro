...
<form method="POST" class="form-custon" action="{{route('profile.update')}}">
    ...
    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
        ...
        <input id="email" type="email" class="form-control" name="email" value="{{ auth()->user()->email }}" disabled="disabled">
    ...
    <div class="form-group{{ $errors->has('district') ? ' has-error' : '' }}">
        ...
        <input id="district" type="text" class="form-control" name="district" placeholder="Bairro:" value="{{ auth()->user()->district }}" required>
  ...
  <button type="submit" class="btn btn-botao">Enviar</button>
</form>
